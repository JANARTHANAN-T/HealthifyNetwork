...
import contact from '../../assert/image/contactus.png'
    ...
    <div className='contact'>
      <div className='row mt-5 mx-0'>
        <div className="col-md-6 text-center my-auto mt-5">
          ...
          <div className='my-5 fs-4 pt-3' >
            &copy; copyrights 2022
          </div>
        </div>
        <div className="col-md-6 d-flex justify-content-center">
          <img src={contact} alt="" className='hidden-img' height="400px" />
        </div>
      </div>
      </div>
    </div>
